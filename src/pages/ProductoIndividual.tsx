...
const ProductoIndividual = () => {
    ...
    return (
        <>
            ...
            <div className=" py-10  max-w-6xl mx-auto px-4  flex flex-col md:flex-row gap-12">
                    ...
                    <div className="w-full md:w-3/7 flex flex-col items-center">
                        ...
                        {/* Nombre */}
                        <h1 className="mx-auto md:mx-0 text-center text-2xl font-semibold text-red-500  mb-4">{producto.nombre}</h1>
                        <img
                            src={producto.imagen}
                            alt={producto.nombre}
                    ...
                    <div className="  top-24 py-10 w-full md:w-2/5 flex flex-col justify-start space-y-12">


                        {/* Bloque sku y rating */}
                        <div className="shadow-lg mx-auto md:mx-0 justify-center w-max   flex items-center gap-30">
                        ...
                        {/* Botón y precio */}
                        <div className="mx-auto md:mx-0  w-full justify-center w-max shadow-lg rounded-lg p-4   flex items-center gap-6">
                            <PrimaryButton
                                onClick={handleagregar}
                                className="!text-gray-700 bg-green-400 hover:bg-green-300 rounded-lg px-4 py-2 text-sm w-full sm:w-auto"
                            >
                                Agregar al carrito
                            </PrimaryButton>
